      ...
      <nav className="navbar shadow-none sm:drop-shadow-[0px_4px_34px_rgba(0,0,0,0.1)] flex grow items-center flex-wrap bg-white-300 p-2 fixed top-0 flex-1 z-30 w-full">
        ...
        >
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            <Link href="/premium">
              <a className="nav-menu mt-8 lg:mt-0 lg:inline-flex lg:w-auto w-full lg:items-start lg:justify-center flex text-[18px] text-black sm:text-[16px]">
                <img
            ...
            <Link href="/logoMaker">
              <a className="nav-menu mt-2 lg:mt-0 lg:inline-flex lg:w-auto w-full items-center justify-center text-[18px] text-black sm:text-[16px]">
                Logo Maker
              </a>
            </Link>
            <Link href="/branding-kit">
              <a className="nav-menu mt-2 lg:mt-0 lg:inline-flex lg:w-auto w-full items-center justify-center text-[18px] text-black sm:text-[16px]">
                Brand Kit
              </a>
            </Link>
            <Link href="/logoIndustries">
              <a className="nav-menu mt-2 lg:mt-0 lg:inline-flex lg:w-auto w-full items-center justify-center text-[18px] text-black sm:text-[16px]">
                Logo Ideas
              </a>
            </Link>
