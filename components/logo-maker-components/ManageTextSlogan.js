...
export default function ManageTextSlogan(props) {
    ...
    const handleSloganNameInput = (text) => {
        const SloganName = text.target.value;
        // Log the typed text to the console
        console.log('typed slogan text:', SloganName);
        dispatch(setLogoTextSloganNameEditText(SloganName));
    ...
    const handleFontSize = (size) => {
        ...
        console.log('slogan font size:', fontSize);
        dispatch(setLogoTextSloganNameFontSize(fontSize));
    ...
    const handleFontSizeMouseOut = (event) => {
        ...
        console.log('Mouse Released Slogan Font Size:', fontSize);
    ...
    const handleLetterSpacing = (spacing) => {
        ...
        console.log('Slogan Letter Spacing:', letterSpacing);
        dispatch(setLogoTextSloganNameLetterSpacing(letterSpacing));
    ...
    const handleLetterSpacingMouseOut = (event) => {
        ...
        // Log the selected size to the console
        console.log('Mouse Released Slogan Letter Spacing:', letterSpacing);
    ...
    const handleRotate = (rota) => {
        ...
        console.log('Slogan Rotate:', rotate);
        dispatch(setLogoTextSloganNameRotate(rotate));
    ...
    const handleRotateMouseOut = (event) => {
        ...
        // Log the selected size to the console
        console.log('Mouse Released Slogan rotate:', rotate);
    ...
    const handleAlignment = (algmn) => {
        ...
        console.log('Selected Slogan alignment type:', alimentType);
        dispatch(setLogoTextSloganNameAlignment(alimentType));
    ...
    const handleColorChange = (color) => {
        ...
        console.log('Selected Slogan Color:', color);
        dispatch(setLogoTextSloganNameTextColor(color));
    ...
    const handleOpacityChange = (event) => {
        ...
        console.log('Selected Slogan Opacity:', opacity);
        dispatch(setLogoTextSloganNameTextOpacity(opacity));
    ...
    const handleOpacityMouseOut = (event) => {
        const opacity = event.target.value;
        // Log the selected size to the console
        console.log('Mouse Released Slogan opacity:', opacity);
